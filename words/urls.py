...
urlpatterns = [
	...
	url(r'^update-word-page/(?P<word>\w+)/$',views.update_word_page,name="update_word_page"),
	url(r'^update-quote-page/(?P<quote>\w+)/$',views.update_quote_page,name="update_quote_page"),
	...
	url(r'^update-quote/(?P<quote>\w+)/$',views.update_quote,name="update_quote"),
	#url(r'^update-reading/(?P<reading_id>\w+)/$',views.update_reading,name="update_reading"),

	##########################################################
	##        deleting data pages

	url(r'^delete-word/(?P<word>\w+)/$',views.delete_word,name="delete_word"),
	url(r'^delete-quote/(?P<quote>\w+)/$',views.delete_quote,name="delete_quote"),
	#url(r'^delete-reading/(?P<reading_id>\w+)/$',views.delete_reading,name="delete_reading"),
