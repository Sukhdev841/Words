...
urlpatterns = [
	...
	#url(r'^new-quote/$',views.new_quote_page,name = "new_quote_page"),
	...
	#url(r'^update-quote/(?P<quote_id>\w+)/$',views.update_quote,name="update_quote"),
	...
	#url(r'^delete-quote/(?P<quote_id>\w+)/$',views.delete_quote,name="delete_quote"),
